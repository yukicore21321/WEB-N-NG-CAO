...
{
    /// <inheritdoc />
    public partial class InitialLibrarySetupV4 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BorrowTickets_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowTickets_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BorrowTickets_Employees_ReceivedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowTickets_CreatedByEmployeeId",
                table: "BorrowTickets",
                column: "CreatedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowTickets_CustomerId",
                table: "BorrowTickets",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowTickets_ReceivedByEmployeeId",
                table: "BorrowTickets",
